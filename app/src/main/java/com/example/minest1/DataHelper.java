...
public class DataHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "wardrobe.db"; // DATABASE NAME
    ...
    public static final String QUERY_TABLE_USERS = " CREATE TABLE " + TABLE_USERS
            + "  ( id INTEGER PRIMARY KEY AUTOINCREMENT, full_name TEXT, email TEXT,Dob TEXT,favcolor TEXT, password TEXT ) ";
