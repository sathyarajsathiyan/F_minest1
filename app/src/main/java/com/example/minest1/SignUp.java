...
public class SignUp extends AppCompatActivity {
    ...
    public boolean validate() {
        ...
        if (Full_name.isEmpty()) {
            valid = false;
            txtFull_name.setError("Please enter  Username!");
        } else {
            valid = true;
...
//for dob
        if (Dob.isEmpty()) {
            valid = false;
            txt_Dob.setError("Please enter DOB!");
        } else {
            valid = true;
        ...
        if (Favcolor.isEmpty()) {
            valid = false;
            txt_favcolor.setError("Please enter FavColor!");
        ...
        if (Password.isEmpty()) {
            valid = false;
            txt_password.setError("Please enter enter password!");
